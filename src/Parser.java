...
{
//////////////////////////MY MODIF////////////////////////////////////
	public SwitchStatement tabSwitch;
...
////////////////////////////////////MY MODIF////////////////////////////////////////////////
			else if ( match(TokenTag.SWITCH))
			{
				Expression condition = op();
				tabSwitch = new SwitchStatement(condition);
				inSwitch = true;
				statements.add(tabSwitch);
			}
			else if ( match(TokenTag.CASE)){
				Expression value = op();
				tabSwitch.newCase(value);
			}
			else if ( match(TokenTag.ENDSWITCH)){
				inSwitch = false;
			}
///////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////MY MODIF///////////////////////////////////////////////////////
		else if (match(TokenTag.SQRT))
		{
			consume(TokenTag.LPARA);
			Expression expr = getVar();
			consume(TokenTag.RPARA);
			return new FuncEvalMono(expr, lookBack(4).getTag() );
		}
//////////////////////////////////////////////////////////////////////////////////////////////		
...
//////////////////////////////////////MY MODIF////////////////////////////////////////////////
	public class FuncEvalMono implements Expression
	{
		private Expression expr;
		private TokenTag tag;
		public FuncEvalMono (Expression expr, TokenTag tag)
		{
			this.expr = expr;
			this.tag = tag;
		}
		...
		public Value evaluate()
		{
			...
			{
				case SQRT:
					return new  IntType( (int) Math.sqrt(val.toInt()));
			}
			return null;
		}
	}
...
//////////////////////////////////////////////MY MODIF////////////////////////////////////////
	class SwitchStatement implements Statement
	{
		...
		private HashMap< Expression , ArrayList < Statement > >seqSwitch;
		private Expression current;

		public SwitchStatement(Expression cond )
		{
			this.condition = cond;
			this.seqSwitch = new HashMap< Expression , ArrayList < Statement > >();
		}
		
		public void newCase(Expression expr){
			current = expr;
			seqSwitch.put(current, new ArrayList<Statement>());
		}
		
		public void addStatement(Statement statement){
			seqSwitch.get(current).add(statement);
		}
