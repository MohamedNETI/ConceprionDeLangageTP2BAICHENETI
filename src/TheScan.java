...
//////////////////////////MY MODIF///////////////////////////////////////////////////
					else if ( current.equalsIgnoreCase("SQRT"))
					{
						tokens.add(new Token(current, TokenTag.SQRT));
						current = "";
						tag = TokenTag.NONE;
					}
					else if ( current.equalsIgnoreCase("SWITCH"))
					{
						tokens.add(new Token(current, TokenTag.SWITCH));
						current = "";
						tag = TokenTag.NONE;
					}
					else if ( current.equalsIgnoreCase("CASE"))
					{
						tokens.add(new Token(current, TokenTag.CASE));
						current = "";
						tag = TokenTag.NONE;
					}
					else if ( current.equalsIgnoreCase("ENDSWITCH"))
					{
						tokens.add(new Token(current, TokenTag.ENDSWITCH));
						current = "";
						tag = TokenTag.NONE;
					}
//					else if ( current.equalsIgnoreCase("BREAK"))
//					{
//						tokens.add(new Token(current, TokenTag.BREAK));
//						current = "";
//						tag = TokenTag.NONE;
//					}
////////////////////////////////////////////////////////////////////////////////////
